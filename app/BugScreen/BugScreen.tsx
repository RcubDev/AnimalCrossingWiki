      ...
      <Container>
        ...
        <FlatList
          ...
          renderItem={({ item }: { item: CreatureModel }) => (
            <GridItem model={item} navigation={navigation} updateCaught={updateCreatureCaught} updateDonated={updateCreatureDonated} navigateTo='DetailsScreen' images={BugImages} styles={styles} type='bug' />
          )}
          numColumns={3}
